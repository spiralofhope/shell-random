...
# clean up /d/live/shell-random/git/dead/bash/ and don't forget to export it into the 1 shell-random/git
...
# -- General settings
# --
export  GIT_DIRECTORY='/d/live/Git_For_Windows'
export  shell_random='/d/live/shell-random/git'
