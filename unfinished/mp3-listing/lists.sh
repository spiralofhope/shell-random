...
#   mkdir ./"$1"
  ...
  \find -L $music_dirs_list -name \""$2\"" -exec \ln -s --target-directory="$list_dir"/"$1"/ $3{} \;
}
...
rm -v ./Sevendust*Xmas\ day*
rm -v ./Arch\ Enemy*Snow\ bound*
rm -v ./Clannad*A\ dream\ in\ the\ night*
rm -v ./Enigma*Snow\ of\ the\ sahara*
rm -v ./Luca\ Turilli*Lord\ of\ the\ winter\ snow*
rm -v ./Snow\ *			# The artist "Snow"
rm -v ./Santana*		# The artist "Santana"  You're not santa!
cd ../
