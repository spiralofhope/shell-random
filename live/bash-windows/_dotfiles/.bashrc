...
source  "$shell_random/live/bash and zsh"/lib.sh
source  "$shell_random/live/bash and zsh"/*.sh
source  "$shell_random/live/bash-windows"/lib.sh
source  "$shell_random/live/bash-windows"/*.sh
